...
pipes_structure = [
    AnyPipe([
        AggregatePipe([
            ...
            FindTokensPipe("VERB/nsubj/*/**/*/pobj/*"),
        ]),
        AggregatePipe([
            FindTokensPipe("VERB/nsubjpass/*/**/*/pobj/*/compound/*"),
            FindTokensPipe("VERB/nsubjpass/*/**/*/pobj/*"),
        ]),
    ]),
    AggregatePipe([
        FindTokensPipe("VERB"),
    ...
    AggregatePipe([
        FindTokensPipe("VERB/[dobj,pobj]/[NN,NNP,NNS]"),
        FindTokensPipe("VERB/**/*/[dobj,pobj]/*/compound/[NN,NNP,NNS]"),
        FindTokensPipe("VERB/**/*/[dobj,pobj]/[NN,NNP,NNS]"),
    ])
]

engine = PipelineEngine(pipes_structure, Context(doc))
for i in engine.process():
    print("{}\n".format(i))
